...
class NotificationService {
  ...
  /// Schedule a single notification using timezone
  static Future<void> _scheduleNotification({
    ...
    // Schedule the notification using timezone
  ...
  /// Show immediate notification (for testing or welcome)
  ...
  static Future<void> showWelcomeNotification() async {
    ...
    if (!hasShownWelcome && await arePermissionsGranted()) {
