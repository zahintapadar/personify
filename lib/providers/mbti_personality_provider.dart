...
class MBTIPersonalityProvider extends ChangeNotifier {
  ...
  Future<void> completeTest() async {
    ...
    try {
      ...
      Map<String, double> typeProbabilities = _generateTypeProbabilities(dimensionScores);
  ...
  Map<String, double> _calculateMCQScores() {
    ...
    for (int i = 0; i < _questions.length; i++) {
      ...
      if (answerIndex != null && question.values != null && 
        ...
        if (question.id.contains('energy') || question.id.contains('communication') || 
        ...
        } else if (question.id.contains('information') || question.id.contains('problem') || 
        ...
        } else if (question.id.contains('decision') || question.id.contains('feedback') || 
        ...
        } else if (question.id.contains('planning') || question.id.contains('work') || 
  ...
  void _distributeMixedQuestionScore(PersonalityQuestion question, double value, Map<String, double> scores) {
  ...
  double _calculateConfidence(Map<String, double> scores) {
    ...
    double maxPossibleScore = 15.0; // Theoretical maximum based on question values
  ...
  String _getTypeDescription(String mbtiType) {
    final descriptions = {
      'INTJ': 'The Architect - Independent and strategic, you prefer working alone and focusing on the big picture.',
      'INTP': 'The Thinker - Logical and analytical, you love exploring ideas and understanding complex systems.',
      'ENTJ': 'The Commander - Natural born leader, you are confident and excel at organizing and directing.',
      'ENTP': 'The Debater - Innovative and enthusiastic, you enjoy exploring new possibilities and challenging ideas.',
      'INFJ': 'The Advocate - Compassionate and insightful, you are driven by your values and desire to help others.',
      'INFP': 'The Mediator - Creative and idealistic, you are guided by your personal values and seek harmony.',
      'ENFJ': 'The Protagonist - Charismatic and inspiring, you naturally motivate others toward positive change.',
      'ENFP': 'The Campaigner - Enthusiastic and creative, you see potential in everyone and everything.',
      'ISTJ': 'The Logistician - Practical and responsible, you value tradition and work systematically.',
      'ISFJ': 'The Protector - Caring and meticulous, you dedicate yourself to supporting and protecting others.',
      'ESTJ': 'The Executive - Organized and decisive, you excel at managing projects and leading teams.',
      'ESFJ': 'The Consul - Social and supportive, you work best when helping others and maintaining harmony.',
      'ISTP': 'The Virtuoso - Practical and adaptable, you prefer hands-on problem solving and flexible approaches.',
      'ISFP': 'The Adventurer - Gentle and artistic, you value personal freedom and express yourself creatively.',
      'ESTP': 'The Entrepreneur - Energetic and perceptive, you live in the moment and adapt quickly to change.',
      'ESFP': 'The Entertainer - Spontaneous and enthusiastic, you love interacting with others and trying new experiences.',
    };
    
    return descriptions[mbtiType] ?? 'A unique personality type with balanced traits across all dimensions.';
  }
  
  // Get type strengths
  List<String> _getTypeStrengths(String mbtiType) {
    final strengths = {
      'INTJ': ['Strategic thinking', 'Independent', 'Determined', 'Innovative', 'Analytical'],
      'INTP': ['Logical reasoning', 'Intellectual curiosity', 'Objective analysis', 'Creative problem-solving', 'Independent thinking'],
      'ENTJ': ['Leadership skills', 'Strategic planning', 'Efficient', 'Confident', 'Goal-oriented'],
      'ENTP': ['Creative thinking', 'Enthusiastic', 'Adaptable', 'Good at generating ideas', 'Charismatic'],
      'INFJ': ['Empathetic', 'Insightful', 'Creative', 'Decisive', 'Altruistic'],
      'INFP': ['Empathetic', 'Creative', 'Passionate about values', 'Flexible', 'Open-minded'],
      'ENFJ': ['Natural leadership', 'Empathetic', 'Charismatic', 'Altruistic', 'Good communicator'],
      'ENFP': ['Enthusiastic', 'Creative', 'Sociable', 'Energetic', 'Good people skills'],
      'ISTJ': ['Responsible', 'Practical', 'Fact-minded', 'Reliable', 'Patient'],
      'ISFJ': ['Supportive', 'Reliable', 'Patient', 'Imaginative', 'Observant'],
      'ESTJ': ['Dedicated', 'Strong-willed', 'Direct', 'Honest', 'Loyal'],
      'ESFJ': ['Strong practical skills', 'Loyal', 'Sensitive', 'Warm-hearted', 'Good at connecting with others'],
      'ISTP': ['Optimistic', 'Energetic', 'Creative', 'Practical', 'Spontaneous'],
      'ISFP': ['Charming', 'Sensitive to others', 'Imaginative', 'Passionate', 'Curious'],
      'ESTP': ['Bold', 'Rational', 'Practical', 'Original', 'Perceptive'],
      'ESFP': ['Bold', 'Original', 'Aesthetics', 'Showmanship', 'Practical'],
    };
    
    return strengths[mbtiType] ?? ['Natural leadership', 'Strategic thinking', 'Problem solving'];
  }
  
  // Get type challenges
  List<String> _getTypeChallenges(String mbtiType) {
    final challenges = {
      'INTJ': ['Can be overly critical', 'May dismiss emotions', 'Perfectionist tendencies', 'Difficulty with details'],
      'INTP': ['May neglect practical matters', 'Difficulty with emotions', 'Can be insensitive', 'Procrastination'],
      'ENTJ': ['Can be impatient', 'May overlook feelings', 'Domineering', 'Workaholic tendencies'],
      'ENTP': ['Difficulty with routine', 'May neglect details', 'Can be argumentative', 'Inconsistent follow-through'],
      'INFJ': ['Perfectionist', 'Overly sensitive', 'Reluctant to open up', 'Can burn out easily'],
      'INFP': ['Overly idealistic', 'May take things personally', 'Difficulty with criticism', 'Can be impractical'],
      'ENFJ': ['Overly idealistic', 'Too selfless', 'Overly sensitive', 'Can be manipulative'],
      'ENFP': ['Difficulty focusing', 'Overthink things', 'Get stressed easily', 'Highly emotional'],
      'ISTJ': ['Stubborn', 'Insensitive', 'Always by the book', 'Judgmental'],
      'ISFJ': ['Humble', 'Shy', 'Take things personally', 'Repress feelings'],
      'ESTJ': ['Inflexible', 'Uncomfortable with unconventional situations', 'Judgmental', 'Impatient'],
      'ESFJ': ['Worried about social status', 'Inflexible', 'Reluctant to innovate', 'Vulnerable to criticism'],
      'ISTP': ['Stubborn', 'Insensitive', 'Private', 'Easily bored'],
      'ISFP': ['Fiercely independent', 'Unpredictable', 'Easily stressed', 'Overly competitive'],
      'ESTP': ['Insensitive', 'Impatient', 'Risk-prone', 'Unstructured'],
      'ESFP': ['Sensitive', 'Conflict-averse', 'Easily bored', 'Poor long-term planners'],
    };
    
    return challenges[mbtiType] ?? ['May be overly critical', 'Can appear aloof', 'Might ignore emotions'];
  }
    ...
    try {
      ...
      if (historyJson != null) {
        ...
        _testHistory = historyList
            ...
            .toList();
        debugPrint('Loaded ${_testHistory.length} MBTI test results from history');
      }
    } catch (e) {
  ...
  Future<void> _saveTestToHistory(MBTIPersonalityResult result) async {
    try {
      ...
      debugPrint('Saved MBTI test result to history. Total results: ${_testHistory.length}');
    } catch (e) {
  ...
  List<String> _getMBTITraits(String mbtiType) {
    ...
    final traits = {
      'INTJ': ['Strategic thinking', 'Independent', 'Analytical', 'Future-focused', 'Systematic', 'Confident'],
      'INTP': ['Logical', 'Theoretical', 'Curious', 'Flexible', 'Objective', 'Innovative'],
      'ENTJ': ['Leadership', 'Strategic', 'Decisive', 'Ambitious', 'Organized', 'Confident'],
      'ENTP': ['Innovative', 'Enthusiastic', 'Strategic', 'Adaptable', 'Outgoing', 'Intellectual'],
      'INFJ': ['Insightful', 'Empathetic', 'Creative', 'Inspiring', 'Principled', 'Visionary'],
      'INFP': ['Idealistic', 'Creative', 'Authentic', 'Empathetic', 'Values-driven', 'Flexible'],
      'ENFJ': ['Charismatic', 'Empathetic', 'Inspiring', 'Organized', 'Diplomatic', 'Altruistic'],
      'ENFP': ['Enthusiastic', 'Creative', 'People-focused', 'Adaptable', 'Inspiring', 'Innovative'],
      'ISTJ': ['Reliable', 'Methodical', 'Practical', 'Responsible', 'Thorough', 'Traditional'],
      'ISFJ': ['Caring', 'Loyal', 'Detail-oriented', 'Supportive', 'Practical', 'Patient'],
      'ESTJ': ['Organized', 'Decisive', 'Leadership', 'Practical', 'Efficient', 'Traditional'],
      'ESFJ': ['Caring', 'Sociable', 'Helpful', 'Organized', 'Loyal', 'Traditional'],
      'ISTP': ['Practical', 'Analytical', 'Adaptable', 'Independent', 'Realistic', 'Action-oriented'],
      'ISFP': ['Artistic', 'Gentle', 'Flexible', 'Values-driven', 'Caring', 'Independent'],
      'ESTP': ['Energetic', 'Practical', 'Adaptable', 'Realistic', 'Action-oriented', 'Social'],
      'ESFP': ['Enthusiastic', 'Spontaneous', 'People-focused', 'Optimistic', 'Flexible', 'Fun-loving'],
    };
  ...
  Map<String, String> getCognitiveFunctionDetails(String mbtiType) {
    final functionMappings = {
      'Ni': 'Introverted Intuition: Sees patterns, connections, and future possibilities. Naturally synthesizes information to form insights and see the bigger picture.',
      'Ne': 'Extraverted Intuition: Explores possibilities, generates ideas, and sees connections between different concepts. Naturally brainstorms and thinks outside the box.',
      'Si': 'Introverted Sensing: Recalls past experiences and compares them to present situations. Values tradition, consistency, and proven methods.',
      'Se': 'Extraverted Sensing: Lives in the present moment and responds to immediate opportunities. Notices environmental details and adapts quickly to changes.',
      'Ti': 'Introverted Thinking: Analyzes information logically and creates internal frameworks for understanding. Seeks logical consistency and precision.',
      'Te': 'Extraverted Thinking: Organizes and systematizes the external world efficiently. Focuses on results, productivity, and logical organization.',
      'Fi': 'Introverted Feeling: Evaluates based on personal values and maintains inner harmony. Has strong personal convictions and seeks authenticity.',
      'Fe': 'Extraverted Feeling: Understands and responds to others\' emotions and creates group harmony. Naturally considers others\' feelings and social dynamics.',
    };

    final stackOrder = _getCognitiveStack(mbtiType).split('-');
    
    return {
      'dominant': '${stackOrder[0]}: ${functionMappings[stackOrder[0]] ?? 'Unknown function'}',
      'auxiliary': '${stackOrder[1]}: ${functionMappings[stackOrder[1]] ?? 'Unknown function'}',
      'tertiary': '${stackOrder[2]}: ${functionMappings[stackOrder[2]] ?? 'Unknown function'}',
      'inferior': '${stackOrder[3]}: ${functionMappings[stackOrder[3]] ?? 'Unknown function'}',
    };
  }
  ...
  String getDetailedPersonalityExplanation(String mbtiType) {
    final explanations = {
      'INTJ': 'You are "The Architect" - a strategic, independent, and highly analytical visionary. You see possibilities for improvement everywhere and have a natural gift for seeing the big picture and developing long-term plans. Your mind works like a master strategist, constantly analyzing patterns and developing comprehensive plans for the future.',
      'INTP': 'You are "The Thinker" - a logical, innovative, and curious individual who loves exploring theoretical concepts. You are driven by a desire to understand the underlying principles of everything around you. Your mind works like a sophisticated analytical engine, constantly questioning and seeking to understand.',
      'ENTJ': 'You are "The Commander" - a bold, strategic, and natural-born leader. You excel at organizing people and resources to achieve ambitious goals. Your mind works like a master orchestrator, seeing the big picture and efficiently organizing everything to achieve success.',
      'ENTP': 'You are "The Debater" - an innovative, enthusiastic, and strategic thinker. You thrive on intellectual challenges and generating creative solutions. Your mind works like an idea generator, constantly exploring possibilities and connecting seemingly unrelated concepts.',
      'INFJ': 'You are "The Advocate" - an insightful, principled, and creative individual. You have a unique ability to inspire and guide others toward meaningful goals. Your mind works like a visionary compass, seeing future possibilities while staying true to your deep values.',
      'INFP': 'You are "The Mediator" - an idealistic, loyal, and creative individual driven by your values. You seek to make the world a better place and find authenticity in everything you do. Your mind works like a values-driven artist, creating meaning and seeking authentic expression.',
      'ENFJ': 'You are "The Protagonist" - a charismatic, altruistic, and inspiring leader. You have a natural gift for motivating others and building strong relationships. Your mind works like a people orchestrator, seeing potential in others and inspiring them to achieve it.',
      'ENFP': 'You are "The Campaigner" - an enthusiastic, creative, and people-focused individual. You excel at inspiring others and generating innovative ideas. Your mind works like an enthusiasm engine, spreading energy and inspiring others while generating creative possibilities.',
      'ISTJ': 'You are "The Logistician" - a practical, reliable, and methodical individual. You excel at organizing, planning, and ensuring everything runs smoothly. Your mind works like a precision organizer, creating systematic approaches and maintaining stability.',
      'ISFJ': 'You are "The Protector" - a caring, loyal, and detail-oriented individual. You have a natural gift for supporting others and maintaining harmony. Your mind works like a caring guardian, always considering how to help and protect others.',
      'ESTJ': 'You are "The Executive" - an organized, practical, and decisive individual. You excel at managing people and resources to achieve concrete results. Your mind works like an efficient manager, organizing systems and people to achieve clear objectives.',
      'ESFJ': 'You are "The Consul" - a caring, sociable, and helpful individual. You thrive on building relationships and creating harmony in your environment. Your mind works like a social harmonizer, constantly considering others\' needs and building connections.',
      'ISTP': 'You are "The Virtuoso" - a practical, observant, and adaptable individual. You excel at understanding how things work and solving practical problems. Your mind works like a master craftsperson, analyzing systems and finding practical solutions.',
      'ISFP': 'You are "The Adventurer" - an artistic, gentle, and flexible individual driven by your values. You seek authentic self-expression and value beauty and harmony. Your mind works like an artist\'s palette, creating authentic expressions while staying true to your values.',
      'ESTP': 'You are "The Entrepreneur" - an energetic, practical, and adaptable individual. You thrive in dynamic environments and excel at seizing opportunities. Your mind works like an opportunity detector, quickly responding to immediate situations and possibilities.',
      'ESFP': 'You are "The Entertainer" - an enthusiastic, spontaneous, and people-focused individual. You bring joy and excitement to every situation. Your mind works like a joy spreader, naturally creating positive experiences and connecting with others.',
    };

    return explanations[mbtiType] ?? 'You have a unique personality type with distinctive strengths and characteristics.';
  }
  ...
  List<String> getFamousExamples(String mbtiType) {
    final examples = {
      'INTJ': ['Elon Musk', 'Isaac Newton', 'Nikola Tesla', 'Friedrich Nietzsche', 'Ayn Rand'],
      'INTP': ['Albert Einstein', 'Bill Gates', 'Abraham Lincoln', 'Charles Darwin', 'Marie Curie'],
      'ENTJ': ['Steve Jobs', 'Franklin D. Roosevelt', 'Margaret Thatcher', 'Napoleon Bonaparte', 'Gordon Ramsay'],
      'ENTP': ['Mark Twain', 'Walt Disney', 'Thomas Edison', 'Benjamin Franklin', 'Richard Feynman'],
      'INFJ': ['Martin Luther King Jr.', 'Nelson Mandela', 'Mother Teresa', 'Mahatma Gandhi', 'Carl Jung'],
      'INFP': ['William Shakespeare', 'J.R.R. Tolkien', 'Vincent van Gogh', 'Johnny Depp', 'Kurt Cobain'],
      'ENFJ': ['Oprah Winfrey', 'Barack Obama', 'Maya Angelou', 'John F. Kennedy', 'Malala Yousafzai'],
      'ENFP': ['Robin Williams', 'Ellen DeGeneres', 'Will Smith', 'Quentin Tarantino', 'Robert Downey Jr.'],
      'ISTJ': ['George Washington', 'Warren Buffett', 'Condoleezza Rice', 'Jeff Bezos', 'Natalie Portman'],
      'ISFJ': ['Mother Teresa', 'Kate Middleton', 'Jimmy Carter', 'Captain America', 'Selena Gomez'],
      'ESTJ': ['Henry Ford', 'John D. Rockefeller', 'Frank Sinatra', 'Judge Judy', 'Vince Lombardi'],
      'ESFJ': ['Taylor Swift', 'Bill Clinton', 'Jennifer Garner', 'Danny Glover', 'Mary Tyler Moore'],
      'ISTP': ['Clint Eastwood', 'Michael Jordan', 'Tiger Woods', 'Amelia Earhart', 'Steve Jobs'],
      'ISFP': ['Michael Jackson', 'Rihanna', 'Bob Dylan', 'Frida Kahlo', 'Avril Lavigne'],
      'ESTP': ['Donald Trump', 'Madonna', 'Eddie Murphy', 'Bruce Willis', 'Samuel L. Jackson'],
      'ESFP': ['Marilyn Monroe', 'Elvis Presley', 'Justin Bieber', 'Katy Perry', 'Adele'],
    };
  ...
  List<String> _getCareerSuggestions(String mbtiType) {
    final careers = {
      'INTJ': ['Software Architect', 'Research Scientist', 'Strategic Planner', 'Systems Analyst', 'Investment Banker', 'Professor'],
      'INTP': ['Software Developer', 'Research Scientist', 'Data Analyst', 'University Professor', 'Philosopher', 'Technical Writer'],
      'ENTJ': ['CEO', 'Executive', 'Management Consultant', 'Investment Banker', 'Attorney', 'Project Manager'],
      'ENTP': ['Entrepreneur', 'Marketing Manager', 'Journalist', 'Lawyer', 'Psychologist', 'Inventor'],
      'INFJ': ['Counselor', 'Writer', 'Social Worker', 'Teacher', 'Psychologist', 'Human Rights Advocate'],
      'INFP': ['Writer', 'Artist', 'Counselor', 'Social Worker', 'Journalist', 'Environmental Scientist'],
      'ENFJ': ['Teacher', 'Counselor', 'Social Worker', 'HR Manager', 'Public Relations', 'Life Coach'],
      'ENFP': ['Marketing Manager', 'Journalist', 'Actor', 'Teacher', 'Social Worker', 'Event Planner'],
      'ISTJ': ['Accountant', 'Engineer', 'Manager', 'Administrator', 'Auditor', 'Project Manager'],
      'ISFJ': ['Nurse', 'Teacher', 'Social Worker', 'Administrator', 'Counselor', 'Human Resources'],
      'ESTJ': ['Manager', 'Administrator', 'Executive', 'Sales Manager', 'Military Officer', 'Judge'],
      'ESFJ': ['Teacher', 'Nurse', 'Social Worker', 'Event Planner', 'HR Manager', 'Counselor'],
      'ISTP': ['Engineer', 'Mechanic', 'Technician', 'Pilot', 'Carpenter', 'Software Developer'],
      'ISFP': ['Artist', 'Designer', 'Musician', 'Counselor', 'Teacher', 'Photographer'],
      'ESTP': ['Sales Manager', 'Entrepreneur', 'Police Officer', 'Paramedic', 'Coach', 'Real Estate Agent'],
      'ESFP': ['Teacher', 'Actor', 'Event Planner', 'Social Worker', 'Photographer', 'Tour Guide'],
    };
